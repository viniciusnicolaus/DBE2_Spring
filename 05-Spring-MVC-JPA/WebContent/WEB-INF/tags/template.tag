	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
	  ...
	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	    <ul class="navbar-nav mr-auto">
	      ...
	      <li class="nav-item">
	        <a class="nav-link" href="<c:url value="/passagem/cadastrar"/>">Cadastrar passagem</a>
	      </li>
	      <li class="nav-item">
	        <a class="nav-link" href="<c:url value="/fruta/editar"/>">#</a>
	      </li>
	      
	      <li class="nav-item">
	      	<a class="nav-link" href="<c:url value="/passagem/listar"/>">Listar passagens</a>
	      </li>
